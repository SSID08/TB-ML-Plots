...
```{r}
write.csv(full_df_plot_Sens,file = 'Data for Sensitivity Plot.csv',quote = F,na = 'NA',row.names = T,col.names = T)
```

```{r}
write.csv(full_df_plot_Spec,file = 'Data for Specificity Plot.csv',quote = F,na = 'NA',row.names = T,col.names = T)
```
